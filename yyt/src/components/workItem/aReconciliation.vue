<template>
  <section>
    <div class="page-funcarea clearfix">
      ...
      <div class="pageFuncarea-btn clearfix fl" style="margin-left:30px;">
    ...
    <!-- 审核弹出层 -->
    <el-dialog title="结算审核" :visible.sync="dialogExamineVisible" class="addcardseg-box" style="width:80%" Examine>
      <el-form>
    ...
    <!-- 调帐弹出层 -->
    <el-dialog title="调帐处理" :visible.sync="dialogAccountAdjustmentVisible" class="addcardseg-box" style="width:80%">
      <el-form >
...
<script>
  import {getGroupFeeList,settlementAudit,institutionalReconciliation,downLoadImg} from '../../axios/axios';
