...
<script>
import QS from 'qs'
import {getPaySearchList,getGroupList} from '../../axios/axios';
    ...
    handleSizeChange(val) {
      ...
      excel_down(){
          ...
          import('@/vendor/Export2Excel').then(excel => {
            const tHeader = ['机构名称', '操作时间','卡号', '姓名', '缴退标识', '金额','设备号','业务类型','订单号']
            const filterVal = ['group_name', 'create_time', 'ic_no','user_name', 'inout_flag', 'amount','oper_code','busi_code','order_id']
